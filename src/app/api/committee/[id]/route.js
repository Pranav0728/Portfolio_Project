...
export async function PUT(req, { params }) {
  try {
    ...
    const result = await Committee.findByIdAndUpdate(id, data, { new: true });
...
export async function DELETE(req, { params }) {
  try {
    ...
    const result = await Committee.findByIdAndDelete(id);
...
export async function GET(req, { params }) {
  try {
    ...
    const result = await Committee.findById(id);
