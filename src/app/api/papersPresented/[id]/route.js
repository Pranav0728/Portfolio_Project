...
export async function PUT(req, { params }) {
  try {
    ...
    const result = await Paperspresented.findByIdAndUpdate(id, data, { new: true });
...
export async function DELETE(req, { params }) {
  try {
    ...
    const result = await Paperspresented.findByIdAndDelete(id);
...
export async function GET(req, { params }) {
  try {
    ...
    const result = await Paperspresented.findById(id);
