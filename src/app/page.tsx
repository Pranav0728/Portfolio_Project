    ...
    <main className="min-h-screen bg-gray-100" id="about">
      ...
      <section className="home section flex justify-center items-center py-20" id="home">
        <div className="container flex gap-5 justify-center items-center">
          {Personal.map((user) => (
            <div key={user.name} className="intro flex gap-5 md:flex-row flex-col justify-center items-center">
              <Image
                src={img}
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className={`text-[2rem] mt-2 text-black ${rokkitt.className}`}>{user.subHeader}</p>
              </div>
            </div>
          ))}
        </div>
